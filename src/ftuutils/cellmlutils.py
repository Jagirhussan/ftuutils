...
#some instances of pyodide fail to import libcellml. Handle this using an exception block
try:
    ...
    def serialiseToCellML(composer,modelName='FTUModel',timeunit='second'):
        raise Exception("Failed to load libcellml, serialisation no supported!")
