...
if __name__ == "__main__":
    ...
    parser.add_argument("--modelfile", help="Location to save model file", default=r"data/Temp/FTUTest\modelzoo\pysrTamap.pkl")
    ...
    if os.path.exists(datadir):
        state2ham = HamiltonianTo_Ta_Map(datadir,ztol,ust2)    
        state2ham.fit(**parms)
        if args.plot:
            state2ham.plot()
