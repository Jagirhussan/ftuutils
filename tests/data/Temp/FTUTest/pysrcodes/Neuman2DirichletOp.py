...
def parse_args():
    ...
    parser.add_argument("--datadir", default=r"data/Temp/FTUTest\data",help="directory in which simulation results are stored")
    parser.add_argument("--outputdir", default=r"data/Temp/FTUTest\modelzoo\DDECSR", help="directory in which results are to be stored")
    parser.add_argument("--pysrmap", default=r"data/Temp/FTUTest\modelzoo\pysr_ham_map.json", help="path to pysr state map description")
    parser.add_argument("-ot","--operatortemplate", default=r"data/Temp/FTUTest\operators.npy", help="path to boundary operator template")
