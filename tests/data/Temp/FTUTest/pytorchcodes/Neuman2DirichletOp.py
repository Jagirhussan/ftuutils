...
def parse_args():
    ...
    parser.add_argument("--datadir", default=r"data/Temp/FTUTest\data",help="directory in which results are to be stored")
    parser.add_argument("--outputdir", default=r"data/Temp/FTUTest\modelzoo\DDECMLP", help="directory in which results are to be stored")
