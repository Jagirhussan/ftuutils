...
uset2 = False
class HamiltonianTo_Ta_MapDatasetLoader(Dataset):
    
    def __init__(self,datadir,ztol=1e-14) -> None:
        self.statename = "Ta"
        self.indexs =  np.array([1,5,9,13,17,21,25,29,33,37,41,45,49,53,57,61,65,69,73,77,81])
...
if __name__ == "__main__":
    ...
    parser.add_argument("--modelpath", help="Location to save model", default=r"data/Temp/FTUTest\modelzoo\pytorchTamap")
    ...
    training_data = HamiltonianTo_Ta_MapDatasetLoader(datadir)    
