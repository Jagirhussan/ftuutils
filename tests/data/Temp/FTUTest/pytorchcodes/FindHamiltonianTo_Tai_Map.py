...
uset2 = False
class HamiltonianTo_Tai_MapDatasetLoader(Dataset):
    
    def __init__(self,datadir,ztol=1e-14) -> None:
        self.statename = "Tai"
        self.indexs =  np.array([0,4,8,12,16,20,24,28,32,36,40,44,48,52,56,60,64,68,72,76,80])
...
if __name__ == "__main__":
    ...
    parser.add_argument("--modelpath", help="Location to save model", default=r"data/Temp/FTUTest\modelzoo\pytorchTaimap")
    parser.add_argument("--datadir", help="Location to data", default=r"data/Temp/FTUTest\data")
    parms = {}
    ...
    training_data = HamiltonianTo_Tai_MapDatasetLoader(datadir)    
