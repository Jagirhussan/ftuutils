...
uset2 = False
class HamiltonianTo_u_MapDatasetLoader(Dataset):
    
    def __init__(self,datadir,ztol=1e-14) -> None:
        self.statename = "u"
        self.indexs =  np.array([2,6,10,14,18,22,26,30,34,38,42,46,50,54,58,62,66,70,74,78,82])
...
if __name__ == "__main__":
    ...
    parser.add_argument("--modelpath", help="Location to save model", default=r"data/Temp/FTUTest\modelzoo\pytorchumap")
    ...
    training_data = HamiltonianTo_u_MapDatasetLoader(datadir)    
