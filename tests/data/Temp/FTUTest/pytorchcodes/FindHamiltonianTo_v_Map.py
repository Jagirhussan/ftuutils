...
uset2 = False
class HamiltonianTo_v_MapDatasetLoader(Dataset):
    
    def __init__(self,datadir,ztol=1e-14) -> None:
        self.statename = "v"
        self.indexs =  np.array([3,7,11,15,19,23,27,31,35,39,43,47,51,55,59,63,67,71,75,79,83])
...
if __name__ == "__main__":
    ...
    parser.add_argument("--modelpath", help="Location to save model", default=r"data/Temp/FTUTest\modelzoo\pytorchvmap")
    ...
    training_data = HamiltonianTo_v_MapDatasetLoader(datadir)    
